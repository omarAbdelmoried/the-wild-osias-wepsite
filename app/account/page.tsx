...
import { getBookings } from "@/features/reservation/services/reservation.data.services";
import {
  ArrowRightIcon,
  CalendarDaysIcon,
  CheckCircleIcon,
...
export default async function Page() {
  ...
  const upcomingCabin = upcomingBooking
    ? Array.isArray(upcomingBooking.cabins)
      ? upcomingBooking.cabins[0]
      : upcomingBooking.cabins
    : null;
        ...
        <section className="overflow-hidden border border-primary-800 bg-primary-900">
          <div className="flex flex-col lg:flex-row">
            <div className="relative min-h-64 lg:min-h-0 lg:w-2/5">
              <Image
                src={upcomingCabin.image}
                alt={`Cabin ${upcomingCabin.name}`}
                fill
